    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                payload = query_string_1["default"].stringify(__assign(__assign({ username: credentials.username, password: credentials.password, grant_type: credentials.grantType, client_id: credentials.clientId, totp: credentials.totp, scope: credentials.scope }, (credentials.offlineToken ? { scope: 'offline_access' } : {})), (credentials.refreshToken ? {
